...
## 深圳联友科技有限公司-安卓开发 (2024年2月到2025年1月)
1. 手机互联app开发，hicar和carlink连接、界面、音频焦点等问题排查及修复。（kotlin开发语言）
2. 能源中心app开发，自定义view实现柱状图、自定义view实现电池动效果、加载并显示lottie动画、解决性能问题。（kotlin开发语言）
3. 系统ui和launcher的开发和问题修复，修复一些拖拽和ui界面相关的问题。（java开发语言）
4. M20车机系统ui开发和界面适配。（java开发语言）
...
- 安卓原生开发: java/kotlin
- 操作系统：macos(10年)/windows(20年)/linux(13年)
- 版本管理、文档和自动化部署工具：Git/Git Flow/Jenkins
- 单元测试：Junit
- 后端框架: akka/spring/scala/
